...
export const featuresList: FeaturesItemType[] = [
    {
        ...
        description: "Слідкуй за актуальною локацією водія та завжди будь в курсі де зараз Твій бус або відправлена Тобою посилка. Ми не Uber, але теж круто!"
    },
    {
        icon: icons.phone,
        title: "Онлайн бронювання у додатку",
        description: "Швидке бронювання онлайн! Забудь про сотні дзвінків перед поїздкою!"    
    },
    {
        icon: icons.info,
        title: "Статус поїздки",
        description: "Додаток нагадає про поїздку та повідомить тебе, як тільки водій вирушить в дорогу!"
    },
      {
        icon: icons.car,
